...
#0001 =     a b c d
def seQ1():    coilOff(d);       coilOff(c);       coilOff(b);       coilOn(a);       return()
#0010
def seQ2():    coilOff(d);       coilOff(c);       coilOn(b);       coilOff(a);       return()
#0100
def seQ3():    coilOff(d);       coilOn(c);       coilOff(b);       coilOff(a);       return()
#1000
def seQ4():    coilOn(d);       coilOff(c);       coilOff(b);       coilOff(a);       return()
